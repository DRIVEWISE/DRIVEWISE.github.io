...
<style>
  ...
  {% assign people = site.people_pages | where_exp: "person", "person.member_type == 'researcher' or person.member_type == 'student'" %}
  {% assign people = people | sort: "surname" %}
  ...
  {% assign people = site.people_pages | where_exp: "person", "person.member_type == 'ex'" %}
  {% assign people = people | sort: "surname" %}
